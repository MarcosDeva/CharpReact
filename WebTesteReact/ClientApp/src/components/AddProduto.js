            ...
            <form onSubmit={this.handleSalve}>
                ...
                <div className="form-group row">
                    <div className="col-md-4">
                        <input className="form-control" type="text" name="nome" placeholder="Nome Produto" defaultValue={this.state.produto.nome} required />
                    </div>
                </div>
                <div className="form-group row">
                    <div className="col-md-4">
                        <input className="form-control" type="text" name="descricao" placeholder="Descrição Produto" defaultValue={this.state.produto.descricao} required />
                    </div>
                </div>
